          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <c:if test="${userType=='admin'}">	
		               ...
		               <li class="nav-item">
		                ...
		                <li class="nav-item">
		                <a href="/ticket/userAccount" class="nav-link">
		            ...
		            <c:if test="${userType=='user'}">
				 		  ...
				 		  <li class="nav-item">
			                <a href="/ticket/user/home" class="nav-link">
			                  <i class="fa fa-history nav-icon"></i>
			                  <p style="color:white;">Booking History</p>
			                </a>
			              </li>
			               <li class="nav-item">
			                <a href="/ticket/user/booking" class="nav-link">
		              ...
		              <li class="nav-item">
		                <a href="/ticket/logout" class="nav-link">
